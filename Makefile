...
SRCS			=	$(SRC_DIR)/minishell.c $(SRC_DIR)/minishell_utils.c $(SRC_DIR)/debug.c $(SRC_DIR)/gc.c \
					...
					$(PARSING_DIR)/expand_utils.c $(PARSING_DIR)/process_heredoc.c $(PARSING_DIR)/process_word.c\
					$(PARSING_DIR)/helpers.c $(PARSING_DIR)/expand_helpers.c $(PARSING_DIR)/lexer_helper.c \
					...
					$(EXEC_DIR)/exec.c $(EXEC_DIR)/set_cmd_path.c $(EXEC_DIR)/utils.c $(EXEC_DIR)/utils2.c \
